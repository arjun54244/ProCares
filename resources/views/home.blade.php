					...
					<div class="row align-items-center">
						<div class="col-lg-6">
							<div class="banner-content aos" data-aos="fade-up">
								...
								<img src="{{asset('assets/img/icons/header-icon.svg')}}" class="header-icon" alt="header-icon">
								<p>Embark on your healing journey with Doccure</p>
								<a href="booking.html" class="btn">Start a Consult</a>
								<div class="banner-arrow-img">
									<img src="{{asset('assets/img/down-arrow-img.png')}}" class="img-fluid" alt="down-arrow">
								</div>
							</div>
						...
						<div class="col-lg-6">
							<div class="banner-img aos" data-aos="fade-up">
								<img src="{{asset('assets/img/banner-img.png')}}" class="img-fluid" alt="patient-image">
								<div class="banner-img1">
									<img src="{{asset('assets/img/banner/banner-img1.svg')}}" class="img-fluid" alt="checkup-image">
								</div>
								<div class="banner-img2">
									<img src="{{asset('assets/img/banner/banner-img2.svg')}}" class="img-fluid" alt="doctor-slide">
								</div>
								<div class="banner-img3">
									<img src="{{asset('assets/img/banner/banner-img3.svg')}}" class="img-fluid" alt="doctors-list">
								</div>
							</div>
						</div>
					</div>
