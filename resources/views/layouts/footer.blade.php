...
<footer class="footer footer-one">
		...
		<!-- jQuery -->
		<script data-cfasync="false" src="{{asset('assets/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js')}}"></script><script src="assets/js/jquery-3.7.1.min.js" type="36ceda772e0cd37651382bcb-text/javascript"></script>
	...
	<script src="{{asset('assets/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js')}}" data-cf-settings="36ceda772e0cd37651382bcb-|49" defer></script></body>

<!-- Mirrored from doccure.dreamstechnologies.com/html/template/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 04 Nov 2024 06:39:45 GMT -->
</html>